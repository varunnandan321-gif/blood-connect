                                        ...
                                        <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700 flex justify-between items-center">
                                            ...
                                            {user?.uid !== req.requesterId && (
                                                <button
                                                    ...
                                                    className="bg-red-50 text-red-600 hover:bg-red-600 hover:text-white dark:bg-red-900/20 dark:hover:bg-red-600 font-bold px-5 py-2 rounded-lg transition-colors shadow-sm text-sm"
                                                >
                                                    I can donate
                                                </button>
                                            )}
